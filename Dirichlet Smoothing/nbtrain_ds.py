...
if __name__ == '__main__':
	...
	for i in neg_words.keys():
		neg_prob[i] = ((neg_words[i]+(Mew*(collection_dictionary[i]/(neg_words_count+pos_words_count))))/(neg_words_count + Mew))

	for i in pos_words.keys():
		pos_prob[i] = ((pos_words[i]+(Mew*(collection_dictionary[i]/(pos_words_count+neg_words_count))))/(pos_words_count + Mew))
